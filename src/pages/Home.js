      ...
      <div className="home-container">
        ...
        <div className="intro-card">
          <h1 className="intro-title">
            Hey, I'm <span className="highlight">Aman</span> 👋
          </h1>
          ...
          <p className="intro-text">
            ...
            With a strong foundation in modern front-end development, I thrive
            on tackling complex problems and transforming ideas into intuitive,
            user-friendly digital solutions.
          </p>

          <p className="intro-text">
            Skilled in <strong>React.js</strong>, <strong>JavaScript</strong>,{" "}
            <strong>Node.js</strong>, <strong>Express.js</strong>,{" "}
            <strong>Mongo DB</strong>,<strong> HTML/CSS</strong>, and backend
            fundamentals, I focus on building scalable web apps while
