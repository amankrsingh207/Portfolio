...
function Coding() {
  const [skillGroups, setSkillGroups] = useState({
    ...
    Tools: ["Git", "VS Code", "Node.js", "IntelliJ"],
    "CS Core": [
      "Data Structures",
      "Algorithms",
      "DBMS",
  ...
  const [profiles, setProfiles] = useState([
    { name: "LeetCode", link: "https://leetcode.com/u/Aman_kumar_singh2004/" },
    {
      name: "Coding Ninjas",
      link: "https://www.naukri.com/code360/profile/4eddd07f-9374-4cc2-a5eb-414270de27b5",
    },
    {
      name: "Codeforces",
      link: "https://codeforces.com/profile/Aman_kumar_singhN2004",
    },
    { name: "GitHub", link: "https://github.com/amankrsingh207" },
  ]);
  ...
  const [newSkills, setNewSkills] = useState(
    Object.keys(skillGroups).reduce(
      (acc, group) => ({ ...acc, [group]: "" }),
      {}
    )
  );
  ...
  const handleAddProfile = () => {
    if (newProfileName.trim() && newProfileLink.trim()) {
      setProfiles([
        ...profiles,
        { name: newProfileName.trim(), link: newProfileLink.trim() },
      ]);
      setNewProfileName("");
      setNewProfileLink("");
    }
    ...
    <section className="coding-section">
      <div className="coding-container">
        ...
        <p className="coding-intro">
          Explore my tech stack and the platforms where I sharpen my coding
          skills.
        </p>
